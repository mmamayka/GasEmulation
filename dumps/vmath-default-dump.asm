...
0000000000000070 <Math::Vec4::sqlen() const>:
  70:	c5 fa 10 47 04       	vmovss xmm0,DWORD PTR [rdi+0x4]
  75:	c5 fa 10 17          	vmovss xmm2,DWORD PTR [rdi]
  79:	c5 fa 59 c0          	vmulss xmm0,xmm0,xmm0
  7d:	c4 e2 79 99 d2       	vfmadd132ss xmm2,xmm0,xmm2
  82:	c5 fa 10 47 08       	vmovss xmm0,DWORD PTR [rdi+0x8]
  87:	c4 e2 79 b9 d0       	vfmadd231ss xmm2,xmm0,xmm0
  8c:	c5 fa 10 47 0c       	vmovss xmm0,DWORD PTR [rdi+0xc]
  91:	c4 e2 69 99 c0       	vfmadd132ss xmm0,xmm2,xmm0
  96:	c3                   	ret    
